...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{imatges/mapa_restaurants.png}\par\vspace{1cm}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{imatges/diagrama_voronoi_ordre_1.png}\par\vspace{1cm}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{imatges/diagrama_voronoi_ordre_2.png}\par\vspace{1cm}
